...
``` r
### ERROR HERE ### 
#Andrew's Rationale: load.packages isn't the right way to load an installed package. Should be Library() with the package name inside
...
``` r
### ERROR HERE ###
#Many of the parameters used are wrong
...
``` r
### ERROR HERE ###
#Need to add birth location in quotation marks 
